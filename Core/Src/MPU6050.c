...
//		HAL_I2C_Mem_Write(I2Cx, MPU6050_ADDR, SMPLRT_DIV_REG, 1, &MPU6050_tx, 1,
//				100);
//		HAL_Delay(10);
//
//		MPU6050_tx = DLPF_CFG; // Digital Low Pass Filter Setting
//		HAL_I2C_Mem_Write(I2Cx, MPU6050_ADDR, CONFIG_REG, 1, &MPU6050_tx, 1,
//				100);
//		HAL_Delay(10);
//
//		MPU6050_tx = Gyro_FS << 3;
//		HAL_I2C_Mem_Write(I2Cx, MPU6050_ADDR, GYRO_CONFIG_REG, 1, &MPU6050_tx,
//				1, 100);
//		HAL_Delay(10);
//
//		MPU6050_tx = Acc_FS << 3;
...
void MPU6050_Read_All_DMA(I2C_HandleTypeDef *I2Cx) {
	HAL_I2C_Mem_Read_DMA(I2Cx, MPU6050_ADDR, EXT_SENS_DATA_00, 1,
			MPU6050_rx_buf, 6);
}
